...
namespace MSUMALog.Server.Migrations
{
    ...
    [Migration("20250828092356_Rename_EstimateCostOfMACurrency_To_EstimateCostOfMaCurrency")]
    partial class Rename_EstimateCostOfMACurrency_To_EstimateCostOfMaCurrency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MSUMALog.Server.Models.IncidentAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MSUMALog.Server.Models.IncidentReport", b =>
                {
                    ...
                    b.Property<decimal>("EstimateCostOfMa")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("EstimateCostOfMaCurrency")
                        .IsRequired()
                        .HasMaxLength(3)
            ...
            modelBuilder.Entity("MSUMALog.Server.Models.IncidentAttachment", b =>
                {
                    ...
                    b.HasOne("MSUMALog.Server.Models.IncidentReport", "Incident")
                        .WithMany()
